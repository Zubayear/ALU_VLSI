...
REC(60,-65,30,120,r)
VIS 5
PIN(55,50,0.000,0.000)S3
PIN(55,20,0.000,0.000)S0
PIN(55,40,0.000,0.000)S2
PIN(55,30,0.000,0.000)S1
PIN(55,-60,0.000,0.000)A0
PIN(55,-20,0.000,0.000)B0
PIN(55,-50,0.000,0.000)A1
PIN(55,-10,0.000,0.000)B1
PIN(55,-40,0.000,0.000)A2
PIN(55,0,0.000,0.000)B2
PIN(55,-30,0.000,0.000)A3
PIN(55,10,0.000,0.000)B3
PIN(95,-10,0.060,0.070)Sign
PIN(95,-60,0.060,0.070)Carry
PIN(95,-30,0.060,0.070)out2
PIN(95,-40,0.060,0.070)out1
PIN(95,-20,0.060,0.070)out3
PIN(95,-50,0.060,0.070)out0
LIG(55,50,60,50)
LIG(55,20,60,20)
LIG(55,40,60,40)
LIG(55,30,60,30)
...
LIG(90,-65,90,55)
LIG(90,55,60,55)
VLG  module global( S3,S0,S2,S1,A0,B0,A1,B1,
VLG   A2,B2,A3,B3,Sign,Carry,out2,out1,
VLG   out3,out0);
VLG   input S3,S0,S2,S1,A0,B0,A1,B1;
VLG   input A2,B2,A3,B3;
VLG   output Sign,Carry,out2,out1,out3,out0;
...
VLG   nand #(56) nand_1B1(w27,A1,B1);
...
VLG   pmos #(40) pmos_XO11_FU11_1B12(w33,vdd,A1); //  
VLG   nmos #(40) nmos_XO12_FU12_1B13(w33,vss,A1); //  
VLG   pmos #(66) pmos_XO13_FU13_1B14(w34,B1,A1); //  
VLG   nmos #(66) nmos_XO14_FU14_1B15(w34,B1,w33); //  
VLG   pmos #(66) pmos_XO15_FU15_1B16(w34,A1,B1); //  
VLG   nmos #(66) nmos_XO16_FU16_1B17(w34,w33,B1); //  
...
VLG   pmos #(53) pmos_AN29_FU29_1B30(w44,vdd,A1); //  
VLG   pmos #(53) pmos_AN30_FU30_1B31(w44,vdd,B1); //  
VLG   nmos #(53) nmos_AN31_FU31_1B32(w44,w45,A1); //  
VLG   nmos #(14) nmos_AN32_FU32_1B33(w45,vss,B1); //  
...
VLG   pmos #(36) pmos_NO45_1B46(w56,vdd,A1); //  
VLG   nmos #(36) nmos_NO46_1B47(w56,vss,A1); //  
VLG   pmos #(55) pmos_na47_1B48(w27,vdd,A1); //  
VLG   pmos #(55) pmos_na48_1B49(w27,vdd,B1); //  
VLG   nmos #(55) nmos_na49_1B50(w27,w57,A1); //  
VLG   nmos #(13) nmos_na50_1B51(w57,vss,B1); //  
...
VLG   pmos #(39) pmos_NO11_FU61_1B62(w63,vdd,A1); //  
VLG   nmos #(39) nmos_NO12_FU62_1B63(w63,vss,A1); //  
...
VLG   pmos #(40) pmos_XO19_FU69_1B70(w68,vdd,A1); //  
VLG   nmos #(40) nmos_XO20_FU70_1B71(w68,vss,A1); //  
VLG   pmos #(66) pmos_XO21_FU71_1B72(w69,B1,A1); //  
VLG   nmos #(66) nmos_XO22_FU72_1B73(w69,B1,w68); //  
VLG   pmos #(66) pmos_XO23_FU73_1B74(w69,A1,B1); //  
VLG   nmos #(66) nmos_XO24_FU74_1B75(w69,w68,B1); //  
...
VLG   pmos #(53) pmos_AN31_FU81_1B82(w72,vdd,B1); //  
VLG   pmos #(53) pmos_AN32_FU82_1B83(w72,vdd,w63); //  
VLG   nmos #(53) nmos_AN33_FU83_1B84(w72,w73,B1); //  
...
VLG   pmos #(38) pmos_XN97_1B98(w86,vdd,A1); //  
VLG   nmos #(38) nmos_XN98_1B99(w86,vss,A1); //  
VLG   nmos #(36) nmos_XN99_1B100(w54,vss,w87); //  
VLG   pmos #(36) pmos_XN100_1B101(w54,vdd,w87); //  
VLG   pmos #(62) pmos_XN101_1B102(w87,B1,A1); //  
VLG   nmos #(62) nmos_XN102_1B103(w87,B1,w86); //  
VLG   pmos #(62) pmos_XN103_1B104(w87,A1,B1); //  
VLG   nmos #(62) nmos_XN104_1B105(w87,w86,B1); //  
VLG   pmos #(55) pmos_NO105_1B106(w89,w88,B1); //  
VLG   pmos #(1) pmos_NO106_1B107(w92,w90,w91); //  
VLG   nmos #(1) nmos_NO107_1B108(w94,w93,w91); //  
VLG   pmos #(13) pmos_NO108_1B109(w88,vdd,A1); //  
VLG   nmos #(55) nmos_NO109_1B110(w89,vss,A1); //  
VLG   nmos #(55) nmos_NO110_1B111(w89,vss,B1); //  
VLG   pmos #(42) pmos_NO1_2T1_8T1_16111_1B112(w95,vdd,S2); //  
VLG   nmos #(42) nmos_NO2_2T2_8T2_16112_1B113(w95,vss,S2); //  
...
VLG   pmos #(56) pmos_AN12_2T12_8T12_16122_1B123(w106,vdd,S2); //  
VLG   nmos #(56) nmos_AN13_2T13_8T13_16123_1B124(w106,w107,w105); //  
VLG   nmos #(14) nmos_AN14_2T14_8T14_16124_1B125(w107,vss,S2); //  
...
VLG   pmos #(56) pmos_AN33_4T57_8T57_16167_1B168(w155,vdd,S1); //  
VLG   pmos #(56) pmos_AN34_4T58_8T58_16168_1B169(w155,vdd,S0); //  
VLG   nmos #(56) nmos_AN35_4T59_8T59_16169_1B170(w155,w156,S1); //  
VLG   nmos #(14) nmos_AN36_4T60_8T60_16170_1B171(w156,vss,S0); //  
...
VLG   pmos #(56) pmos_AN41_4T65_8T65_16175_1B176(w162,vdd,S1); //  
VLG   pmos #(56) pmos_AN42_4T66_8T66_16176_1B177(w162,vdd,w163); //  
VLG   nmos #(56) nmos_AN43_4T67_8T67_16177_1B178(w162,w164,S1); //  
...
VLG   pmos #(56) pmos_AN57_4T81_8T81_16191_1B192(w178,vdd,S0); //  
VLG   pmos #(56) pmos_AN58_4T82_8T82_16192_1B193(w178,vdd,w171); //  
VLG   nmos #(56) nmos_AN59_4T83_8T83_16193_1B194(w178,w179,S0); //  
...
VLG   pmos #(69) pmos_NO83_4T107_8T107_16217_1B218(w171,vdd,S1); //  
VLG   nmos #(69) nmos_NO84_4T108_8T108_16218_1B219(w171,vss,S1); //  
VLG   pmos #(69) pmos_NO85_4T109_8T109_16219_1B220(w163,vdd,S0); //  
VLG   nmos #(69) nmos_NO86_4T110_8T110_16220_1B221(w163,vss,S0); //  
...
VLG   pmos #(56) pmos_AN33_4T143_8T143_16253_1B254(w232,vdd,S1); //  
VLG   pmos #(56) pmos_AN34_4T144_8T144_16254_1B255(w232,vdd,S0); //  
VLG   nmos #(56) nmos_AN35_4T145_8T145_16255_1B256(w232,w233,S1); //  
VLG   nmos #(14) nmos_AN36_4T146_8T146_16256_1B257(w233,vss,S0); //  
...
VLG   pmos #(56) pmos_AN41_4T151_8T151_16261_1B262(w239,vdd,S1); //  
VLG   pmos #(56) pmos_AN42_4T152_8T152_16262_1B263(w239,vdd,w240); //  
VLG   nmos #(56) nmos_AN43_4T153_8T153_16263_1B264(w239,w241,S1); //  
...
VLG   pmos #(56) pmos_AN57_4T167_8T167_16277_1B278(w255,vdd,S0); //  
VLG   pmos #(56) pmos_AN58_4T168_8T168_16278_1B279(w255,vdd,w248); //  
VLG   nmos #(56) nmos_AN59_4T169_8T169_16279_1B280(w255,w256,S0); //  
...
VLG   pmos #(69) pmos_NO83_4T193_8T193_16303_1B304(w248,vdd,S1); //  
VLG   nmos #(69) nmos_NO84_4T194_8T194_16304_1B305(w248,vss,S1); //  
VLG   pmos #(69) pmos_NO85_4T195_8T195_16305_1B306(w240,vdd,S0); //  
VLG   nmos #(69) nmos_NO86_4T196_8T196_16306_1B307(w240,vss,S0); //  
VLG   pmos #(42) pmos_NO1_2T1_8T197_16307_1B308(w270,vdd,S2); //  
VLG   nmos #(42) nmos_NO2_2T2_8T198_16308_1B309(w270,vss,S2); //  
...
VLG   pmos #(56) pmos_AN12_2T12_8T208_16318_1B319(w281,vdd,S2); //  
VLG   nmos #(56) nmos_AN13_2T13_8T209_16319_1B320(w281,w282,w280); //  
VLG   nmos #(14) nmos_AN14_2T14_8T210_16320_1B321(w282,vss,S2); //  
...
VLG   pmos #(56) pmos_AN33_4T57_8T253_16363_1B364(w331,vdd,S1); //  
VLG   pmos #(56) pmos_AN34_4T58_8T254_16364_1B365(w331,vdd,S0); //  
VLG   nmos #(56) nmos_AN35_4T59_8T255_16365_1B366(w331,w332,S1); //  
VLG   nmos #(14) nmos_AN36_4T60_8T256_16366_1B367(w332,vss,S0); //  
...
VLG   pmos #(56) pmos_AN41_4T65_8T261_16371_1B372(w338,vdd,S1); //  
VLG   pmos #(56) pmos_AN42_4T66_8T262_16372_1B373(w338,vdd,w339); //  
VLG   nmos #(56) nmos_AN43_4T67_8T263_16373_1B374(w338,w340,S1); //  
...
VLG   pmos #(56) pmos_AN57_4T81_8T277_16387_1B388(w354,vdd,S0); //  
VLG   pmos #(56) pmos_AN58_4T82_8T278_16388_1B389(w354,vdd,w347); //  
VLG   nmos #(56) nmos_AN59_4T83_8T279_16389_1B390(w354,w355,S0); //  
...
VLG   pmos #(69) pmos_NO83_4T107_8T303_16413_1B414(w347,vdd,S1); //  
VLG   nmos #(69) nmos_NO84_4T108_8T304_16414_1B415(w347,vss,S1); //  
VLG   pmos #(69) pmos_NO85_4T109_8T305_16415_1B416(w339,vdd,S0); //  
VLG   nmos #(69) nmos_NO86_4T110_8T306_16416_1B417(w339,vss,S0); //  
...
VLG   pmos #(28) pmos_AN24_4T134_8T330_16440_1B441(w396,vdd,w38