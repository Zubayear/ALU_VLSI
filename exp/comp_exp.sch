DSCH 2.7a
VERSION 29-Mar-20 7:25:09 PM
BB(156,-5,269,130)
SYM  #4bitalu_new_exp
BB(165,0,205,130)
TITLE 175 -2  #4bitalu_new_exp
MODEL 6000
PROP                                                                                                                                                                                                            
REC(170,5,30,120,r)
VIS 5
PIN(165,70,0.000,0.000)B2
PIN(165,30,0.000,0.000)A2
PIN(165,40,0.000,0.000)A3
PIN(165,80,0.000,0.000)B3
PIN(165,60,0.000,0.000)B1
PIN(165,20,0.000,0.000)A1
PIN(165,10,0.000,0.000)A0
PIN(165,50,0.000,0.000)B0
PIN(165,120,0.000,0.000)S3
PIN(165,110,0.000,0.000)S2
PIN(165,100,0.000,0.000)S1
PIN(165,90,0.000,0.000)S0
PIN(205,10,0.060,0.210)Bout
PIN(205,20,0.060,0.210)Cout
PIN(205,30,0.060,0.280)out0
PIN(205,40,0.060,0.280)out1
PIN(205,50,0.060,0.280)out2
PIN(205,60,0.060,0.280)out3
LIG(165,70,170,70)
LIG(165,30,170,30)
LIG(165,40,170,40)
LIG(165,80,170,80)
...
LIG(200,5,200,125)
LIG(200,125,170,125)
VLG   module 4bitalu_new_exp( B2,A2,A3,B3,B1,A1,A0,B0,
...
VLG    nmos #(53) nmos_OR23_FU47_1b46
FSYM
SYM  #light6
BB(263,45,269,59)
TITLE 265 59  #light
...
SYM  #button12
BB(156,116,165,124)
TITLE 160 120  #button
MODEL 59
PROP                                                                                                                                                                                                           
REC(157,117,6,6,r)
VIS 1
PIN(165,120,0.000,0.000)in12
LIG(164,120,165,120)
LIG(156,124,156,116)
LIG(164,124,156,124)
LIG(164,116,164,124)
...
SYM  #button10
BB(156,96,165,104)
TITLE 160 100  #button
MODEL 59
PROP                                                                                                                                                                                                           
REC(157,97,6,6,r)
VIS 1
PIN(165,100,0.000,0.000)in10
LIG(164,100,165,100)
LIG(156,104,156,96)
LIG(164,104,156,104)
LIG(164,96,164,104)
...
LIG(255,50,205,50)
LIG(265,60,205,60)
FFIG C:\Users\user\Downloads\Export dsch2\Export dsch2\Export dsch2\Jubaer_Project\exp\comp_exp.sch
